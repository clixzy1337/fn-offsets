...
namespace offsets
{
    ...
    uintptr_t LocalPawn = 0x350; // Updated AcknowledgedPawn
    uintptr_t PlayerController = 0x30; // Updated AController
    uintptr_t LocalPlayers = 0x38; // Updated LocalPlayers
    ...
    uintptr_t CustomTimeDilation = 0x68; // Updated CustomTimeDilation
}
