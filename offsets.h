   ...
   uintptr_t GNames = 0x130c2a80;
    ...
    uintptr_t pNameStructure = 0xAF8;
    uintptr_t SpeedScale = 0x1A24;
    uintptr_t GravityScale = 0x1DF0;
    ...
    uintptr_t bIsInvulnerable = 0x71a;
    uintptr_t bSpotted = 0x71a;
